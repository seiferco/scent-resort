      ...
      <div className="flex flex-1 items-center justify-center px-4 py-12">
        ...
        >
          <div className="text-center lg:text-left">
            <h1 className="font-display text-3xl font-bold text-foreground uppercase tracking-tight">Sign In</h1>
            <p className="mt-2 text-sm text-foreground-secondary">
              Don&apos;t have an account?{' '}
              <Link href="/register" className="font-bold text-accent hover:opacity-70 transition-opacity">
                Sign up
              </Link>
            </p>
          </div>
